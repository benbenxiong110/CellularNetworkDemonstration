...
CellularNetworkDemonstration::ViewIntroduce::ViewIntroduce(SDL_Renderer* renderer, int viewCode) :ViewBase(renderer, viewCode) {
    m_pIntroduceImage = IMG_LoadTexture(m_pRenderer, "view-introduce.png");
}

CellularNetworkDemonstration::ViewIntroduce::~ViewIntroduce() {
    if (m_pIntroduceImage) {
        SDL_DestroyTexture(m_pIntroduceImage);
    }
}

void CellularNetworkDemonstration::ViewIntroduce::doRender() {
...
void CellularNetworkDemonstration::ViewIntroduce::doUpdate() {
