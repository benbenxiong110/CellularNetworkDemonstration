...
CellularNetworkDemonstration::DemoSidebar::DemoSidebar(SDL_Renderer *renderer) :UIBase(renderer, 600, 440) {
...
CellularNetworkDemonstration::DemoSidebar::~DemoSidebar() {
    // 清理子元素和资源
...
void CellularNetworkDemonstration::DemoSidebar::deepLevel() {
    setLevel(m_iCurrentLevel + 1);
}

void CellularNetworkDemonstration::DemoSidebar::upLevel() {
    setLevel(m_iCurrentLevel - 1);
}

void CellularNetworkDemonstration::DemoSidebar::setLevel(int level) {
    if (level < 0) {
        level = 0;
    }
    if (level > 2) {
...
bool CellularNetworkDemonstration::DemoSidebar::handleEvents(SDL_Event &event) {
...
bool CellularNetworkDemonstration::DemoSidebar::updateListItemLv1(int lv1Type, int lv1Id) {
...
bool CellularNetworkDemonstration::DemoSidebar::updateListItemLv2(int lv1Type, int lv1Id, int lv2Type) {
...
void CellularNetworkDemonstration::DemoSidebar::doRender() {
    SDL_SetRenderDrawColor_DefalutBackground(m_pRenderer);
    SDL_RenderClear(m_pRenderer);
...
void CellularNetworkDemonstration::DemoSidebar::renderLevel(int l) {
    switch (l) {
        case 0:
            // 绘制主页面
            SDL_Texture *texture;
...
int CellularNetworkDemonstration::DemoSidebar::getAnimationValue() {
...
double CellularNetworkDemonstration::DemoSidebar::easeInOut(double val) {
    return ( -0.5 * ( SDL_cos(3.14159 * val) - 1 ) );
}

void CellularNetworkDemonstration::DemoSidebar::doUpdate() {
    if (m_bSwitching) {
        return;
    }
